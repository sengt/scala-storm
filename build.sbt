...
homepage := Some(url("https://github.com/sctang/scala-storm-twitter"))
...
scmInfo := Some(
  ScmInfo(
    url("https://github.com/sctang/scala-storm"),
    "scm:git:https://github.com/sctang/scala-storm.git",
    Some("scm:git:git@github.com:sctang/scala-storm.git")
  )
)
...
/* entry point */
mainClass in (Compile, packageBin) := Some("storm.topology.ExclaimationTopology")

mainClass in (Compile, run) := Some("storm.topology.ExclaimationTopology")
...
pomExtra := (
  <developers>
    <developer>
      <id>sctang</id>
      <name>Seng Tang</name>
      <email>sengctang@gmail.com</email>
...
/* assembly plugin */
mainClass in AssemblyKeys.assembly := Some("storm.topology.ExclamationTopology")
